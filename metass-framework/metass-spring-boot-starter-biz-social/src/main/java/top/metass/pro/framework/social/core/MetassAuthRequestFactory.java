package top.metass.pro.framework.social.core;

import cn.hutool.core.util.EnumUtil;
import cn.hutool.core.util.ReflectUtil;
import top.metass.pro.framework.social.core.enums.AuthExtendSource;
import top.metass.pro.framework.social.core.request.AuthWeChatMiniAppRequest;
 ...
 * @date 2021-10-31
 */
public class MetassAuthRequestFactory extends AuthRequestFactory {
    ...
    public MetassAuthRequestFactory(JustAuthProperties properties, AuthStateCache authStateCache) {
